  ...
  return (
    <>
      ...
      >
        ...
        <kbd className="ml-auto hidden items-center justify-center rounded-sm border p-[2] sm:flex">
          <kbd className="ml-auto hidden rounded border px-2 font-mono text-caption text-muted-foreground drop-shadow-2xl sm:inline">
            {isApple ? "⌘K" : "Ctrl K"}
          </kbd>
        </kbd>
      </button>
